...
var objects_json =  [
	...
	register_weapon("o:bow", "Bow", "items/bow.png", 3, 0.15),
	register_weapon("o:crossbow", "Crossbow", "items/crossbow.png", 5, 0.09),
	register_weapon("o:gun", "Gun", "items/gun.png", 8, 0.03),
	register_weapon("o:sword", "Sword", "items/sword.png", 0, 0.17),
	register_weapon("o:pike", "Pike", "items/pike.png", 3, 0.07),
	register_weapon("o:halberd", "Halberd", "items/halberd.png", 7, 0.06),

	register_real("o:grass", "Grass", "items/grass.png", 0, false, Real, "foliage"),
	register_real("o:haygrass", "Haygrass", "items/haygrass.png", 4, false, Real, "foliage"),
	register_real("o:rock", "Rock", "items/rock.png", 0, true, StaticReal, "decoration"),
	register_real("o:skeleton1", "Skeleton1", "terrain/dead party/skeleton_man.png", 3, false, Real, "decoration"),
	register_real("o:skeleton2", "Skeleton2", "terrain/dead party/skeleton_man2.png", 5, false, Real, "decoration"),
	register_real("o:skeleton3", "Skeleton3", "terrain/dead party/skeleton_man3.png", 7, false, Real, "decoration"),
	register_real("o:skeleton4", "Skeleton4", "terrain/dead party/skeleton_horse.png", 8, false, Real, "decoration"),
	register_real("o:cart", "Cart", "terrain/dead party/cart.png", 9, false, Real, "decoration"),
	...
	4, 1, 50, ["Bow", "Sword", "Pike", "Fists"], 0.2),
